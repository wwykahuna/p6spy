...
/**
 * {@link P6Logger} implementation providing support for pluggable
 * {@link MessageFormattingStrategy}.
 */
public abstract class FormattedLogger implements P6Logger {
	...
	/**
	 * Sets the strategy implementation to use for formatting log message. If not
	 * set, this will default to {@link SingleLineFormat}
	 */
