...
public class P6OptionsRepository {
	...
	public void initCompleted() {
		...
		System.out.println("P6OptionsRepository.initCompleted : fireDelayedOptionChanges() - B");
		fireDelayedOptionChanges();
		System.out.println("P6OptionsRepository.initCompleted : fireDelayedOptionChanges() - E");
	}
	...
	private synchronized void fireDelayedOptionChanges() {
		System.out.println("P6OptionsRepository.fireDelayedOptionChanges : delayedOptionChanges = "+delayedOptionChanges);
		System.out.println("P6OptionsRepository.fireDelayedOptionChanges : listeners = "+listeners);
	...
	public void registerOptionChangedListener(P6OptionChangedListener listener) {
		...
		System.out.println("P6OptionsRepository.registerOptionChangedListener :listeners = "+listeners);
