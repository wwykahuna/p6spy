...
public class ConnectionWrapper extends AbstractWrapper implements Connection {
	...
	public static ConnectionWrapper wrap(Connection delegate, JdbcEventListener eventListener,
			ConnectionInformation connectionInformation) {
		if (delegate == null) {
			return null;
		}
		final ConnectionWrapper connectionWrapper = new ConnectionWrapper(delegate, eventListener,
	 ...
	 */
	protected ConnectionWrapper(Connection delegate, JdbcEventListener jdbcEventListener,
			ConnectionInformation connectionInformation) {
		super(delegate);
		if (delegate == null) {
	...
	public Statement createStatement() throws SQLException {
		return StatementWrapper.wrap(delegate.createStatement(), new StatementInformation(connectionInformation),
				jdbcEventListener);
	}
	...
	public PreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency)
			throws SQLException {
		return PreparedStatementWrapper.wrap(delegate.prepareStatement(sql, resultSetType, resultSetConcurrency),
				new PreparedStatementInformation(connectionInformation, sql), jdbcEventListener);
	}
	...
	public PreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency,
		...
		return PreparedStatementWrapper.wrap(
	...
	public PreparedStatement prepareStatement(String sql, int autoGeneratedKeys) throws SQLException {
		return PreparedStatementWrapper.wrap(delegate.prepareStatement(sql, autoGeneratedKeys),
				new PreparedStatementInformation(connectionInformation, sql), jdbcEventListener);
	}

	@Override
	public PreparedStatement prepareStatement(String sql, int[] columnIndexes) throws SQLException {
		return PreparedStatementWrapper.wrap(delegate.prepareStatement(sql, columnIndexes),
				new PreparedStatementInformation(connectionInformation, sql), jdbcEventListener);
	}

	@Override
	public PreparedStatement prepareStatement(String sql, String[] columnNames) throws SQLException {
		return PreparedStatementWrapper.wrap(delegate.prepareStatement(sql, columnNames),
				new PreparedStatementInformation(connectionInformation, sql), jdbcEventListener);
	}
	...
	public CallableStatement prepareCall(String sql, int resultSetType, int resultSetConcurrency,
			int resultSetHoldability) throws SQLException {
		return CallableStatementWrapper.wrap(
				delegate.prepareCall(sql, resultSetType, resultSetConcurrency, resultSetHoldability),
				new CallableStatementInformation(connectionInformation, sql), jdbcEventListener);
	}
