...
public class StatementWrapper extends AbstractWrapper implements Statement {
	...
	public static Statement wrap(Statement delegate, StatementInformation statementInformation,
	...
	protected StatementWrapper(Statement delegate, StatementInformation statementInformation,
			JdbcEventListener eventListener) {
		super(delegate);
	...
	public ResultSet getResultSet() throws SQLException {
		...
		try {
			return ResultSetWrapper.wrap(delegate.getResultSet(), new ResultSetInformation(statementInformation),
					eventListener);
	...
	public ResultSet executeQuery(String sql) throws SQLException {
		...
		try {
			...
			return ResultSetWrapper.wrap(delegate.executeQuery(sql), new ResultSetInformation(statementInformation),
					eventListener);
		} catch (SQLException sqle) {
			e = sqle;
			throw e;
