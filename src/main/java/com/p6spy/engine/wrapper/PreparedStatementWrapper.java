...
public class PreparedStatementWrapper extends StatementWrapper implements PreparedStatement {
	...
	public static PreparedStatement wrap(PreparedStatement delegate,
			PreparedStatementInformation preparedStatementInformation, JdbcEventListener eventListener) {
		if (delegate == null) {
			return null;
		}
	...
	public ResultSet executeQuery() throws SQLException {
		...
		try {
			...
			return ResultSetWrapper.wrap(delegate.executeQuery(), new ResultSetInformation(statementInformation),
					eventListener);
