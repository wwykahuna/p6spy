...
/**
 * This implementation wraps a {@link ResultSet} and notifies a
...
public class ResultSetWrapper extends AbstractWrapper implements ResultSet {
	...
	public static ResultSet wrap(ResultSet delegate, ResultSetInformation resultSetInformation,
	...
	public ResultSetWrapper(ResultSet delegate, ResultSetInformation resultSetInformation,
			JdbcEventListener eventListener) {
		super(delegate);
