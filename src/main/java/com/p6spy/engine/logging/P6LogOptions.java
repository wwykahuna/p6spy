...
public class P6LogOptions extends StandardMBean implements P6LogLoadableOptions {
	...
	public void setExclude(String exclude) {
		...
		optionsRepository.set(String.class, EXCLUDE,
				P6Util.joinNullSafe(optionsRepository.getSet(String.class, EXCLUDE_LIST), ","));
		optionsRepository.setOrUnSet(Pattern.class, INCLUDE_EXCLUDE_PATTERN, computeIncludeExcludePattern(),
	...
	public void setInclude(String include) {
		...
		// setting effective string
		optionsRepository.set(String.class, INCLUDE,
				P6Util.joinNullSafe(optionsRepository.getSet(String.class, INCLUDE_LIST), ","));
		optionsRepository.setOrUnSet(Pattern.class, INCLUDE_EXCLUDE_PATTERN, computeIncludeExcludePattern(),
				defaults.get(INCLUDE_EXCLUDE_PATTERN));
	}
